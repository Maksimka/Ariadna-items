...
public class PacketPanel extends JPanel {
    ...
    private static final Logger logger = LoggerFactory.getLogger(PacketPanel.class);

    private final PacketTable deliveryPacketTable;

    public PacketPanel(ItemDeliveryTable itemDeliveryTable) {
        this(new BorderLayout(), itemDeliveryTable);
    }

    public PacketPanel(LayoutManager layout, ItemDeliveryTable itemDeliveryTable) {
        super(layout);
        deliveryPacketTable = new PacketTable(itemDeliveryTable);
        ...
        textField.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent event) {
                ...
                if (event.getKeyCode() == KeyEvent.VK_ENTER) {
                    RowFilter<PacketTableModel, Integer> filter =
    ...
    private RowFilter<PacketTableModel, Integer> getFilter(String filterText) {
        RowFilter<PacketTableModel, Integer> filter = null;
    ...
    private void addActionToToolBar(JToolBar tools) {
        JButton create = new JButton(new AbstractAction("Выдать") {
            ...
            public void actionPerformed(ActionEvent e) {
                CreatePacketDialog packetDialog = new CreatePacketDialog();
